...
public class ServerListManager {
    ...
    class GetServerListTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                log.error(name, "DIAMOND-XXXX", "[update-serverlist] failed to update serverlist from address server!", e);
            }
        }
    }
    ...
    private void updateIfChanged(List<String> newList) {
        if (null == newList || newList.isEmpty()) {
        	...
        	log.warn("Diamond-0001", LoggerHelper.getErrorCodeStr("Diamond", "Diamond-0001", "环境问题","[update-serverlist] current serverlist from address server is empty!!!"));
    ...
    static public Map<String, String> ipPortMap = new HashMap<String, String>();
